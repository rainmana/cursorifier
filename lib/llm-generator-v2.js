...
export async function generateWithLLM(repoContent, guidelines, outputDir = '.', description, ruleType, options = { provider: 'anthropic' }) {
...
async function generateWithProvider(repoContent, guidelines, outputDir = '.', description, ruleType, options = { provider: 'anthropic' }) {
