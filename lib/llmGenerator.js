...
export async function generateWithLLM(repoContent, guidelines, outputDir = '.', description, ruleType, provider = 'claude-3-7-sonnet-latest', chunkSize = CHUNK_SIZE) {
...
async function generateWithClaude(repoContent, guidelines, outputDir = '.', description, ruleType, provider = 'claude-3-7-sonnet-latest', chunkSize) {
